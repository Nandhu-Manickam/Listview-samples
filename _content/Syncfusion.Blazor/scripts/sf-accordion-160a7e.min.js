(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["sf-accordion"],{
...
window.sfBlazor.Accordion = function () {
  ...
  function () {
    ...
    SfAccordion.prototype.clickHandler = function (e) {
      var _this = this;
      ...
      if (ctnCheck && (sf.base.isNullOrUndefined(acrdnCtn) || !sf.base.isNullOrUndefined(sf.base.select('.' + CLS_HEADER + ' .' + CLS_TOOGLEICN, acrdnCtnItem)))) {
        ...
        if (!sf.base.isNullOrUndefined(this.options.items) && this.options.items.length > 0) {
          // tslint:disable-next-line:no-any
          this.dotNetRef.invokeMethodAsync('OnItemClick', index).then(function () {
            _this.afterContentRender(trgt, eventArgs, acrdnItem, acrdnHdr, acrdnCtn, acrdnCtnItem);
          });
        } else if (!sf.base.isNullOrUndefined(this.options.dataSource) && this.options.dataSource.length > 0) {
          // tslint:disable-next-line:no-any
          this.dotNetRef.invokeMethodAsync('OnDataClick', id).then(function () {
            _this.afterContentRender(trgt, eventArgs, acrdnItem, acrdnHdr, acrdnCtn, acrdnCtnItem);
          });
        }
      } else {
    ...
    SfAccordion.prototype.afterContentRender = function (trgt, eventArgs, acrdnItem, acrdnHdr, acrdnCtn, acrdnCtnItem) {
      var _this = this;

      var acrdActive = [];
      this.dotNetRef.invokeMethodAsync('TriggerClickedEvent', eventArgs);
    ...
    SfAccordion.prototype.expand = function (trgt) {
      ...
      this.dotNetRef.invokeMethodAsync('TriggerExpandingEvent', eventArgs);
    };
    ...
    SfAccordion.prototype.collapse = function (trgt) {
      ...
      this.dotNetRef.invokeMethodAsync('TriggerCollapsingEvent', eventArgs);
    };
    ...
    SfAccordion.prototype.getItems = function () {
      var items;

      if (!sf.base.isNullOrUndefined(this.options.dataSource) && this.options.dataSource.length > 0) {
        items = this.options.dataSource;
      } else if (!sf.base.isNullOrUndefined(this.options.items) && this.options.items.length > 0) {
  ...
  var Accordion = {
    ...
    animationChanged: function animationChanged(element, animation) {
      if (element && element.blazor__instance) {
        element.blazor__instance.options.animation = animation;
      }
    },
    setExpandMode: function setExpandMode(element, expandMode) {
      if (element && element.blazor__instance) {
