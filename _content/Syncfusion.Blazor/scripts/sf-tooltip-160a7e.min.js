...
window.sfBlazor.Tooltip = function () {
  ...
  function () {
    ...
    SfTooltip.prototype.checkForOpen = function (opensOn, element) {
      var isOpenable = true;

      if (opensOn === 'Hover') {
        isOpenable = element.matches(':hover');
      } else if (opensOn === 'Focus') {
        isOpenable = element.matches(':focus');
      } else if (opensOn === 'Click') {
        isOpenable = document.activeElement === element;
      }
    ...
    SfTooltip.prototype.targetHover = function (e) {
      if (!this.checkForOpen(this.properties.opensOn, this.element)) {
        return;
      }
    ...
    SfTooltip.prototype.hideTooltip = function (hideAnimation, e, targetElement) {
      ...
      var hide = function hide() {
        if (_this.checkForOpen(_this.properties.opensOn, _this.element)) {
          return;
        }
